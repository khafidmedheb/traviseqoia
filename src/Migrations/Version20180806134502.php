 ...
 */
final class Version20180806134502 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE food_record (id INT AUTO_INCREMENT NOT NULL, recorded_at DATE NOT NULL, entitled LONGTEXT NOT NULL, calories INT NOT NULL, username LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
